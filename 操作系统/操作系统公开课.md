...
1. 信号量的引出：如图5，在生产者与消费者模式中，counter不能表达是一个生产者还是2个生产者。只发一次信号，无法解决问题：如果根据counter来判断是否发信号，只能发一次信号，即只能唤醒一个生产者。因此还需要一个变量来记录：
   - 图5：
     ...
     <img src="https://github.com/xuzhuang1996/MyJava/blob/master/img/操作系统/5.PNG" width=50% height=50% />
   - 能记录有多个进程等待
...
3. 代码，图6：
   - 图6：
     ...
     <img src="https://github.com/xuzhuang1996/MyJava/blob/master/img/操作系统/6.PNG" width=50% height=50% />
