...
11. HBase.
12. [HIVE](https://github.com/sunnyandgood/BigData/blob/master/Hive/Hive%E7%AE%80%E4%BB%8B.md)：Hive的表对应HDFS的目录（或文件夹）；Hive表中的数据对应HDFS的文件。我的理解：作为解析器的存在，在hive写好sql,然后解析给Hadoop执行。架构如下图：
